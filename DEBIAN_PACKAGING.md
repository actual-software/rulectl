...
The debian/changelog file is generated dynamically during CI builds to match the release version. It's not stored in git to avoid conflicts and maintain a single source of truth from the release process.
...
5. Do not add debian/changelog - it's generated by CI
